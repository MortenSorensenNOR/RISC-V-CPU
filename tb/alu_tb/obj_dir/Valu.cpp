...
VL_INLINE_OPT void Valu::_combo__TOP__1(Valu__Syms* __restrict vlSymsp) {
    ...
    Valu* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->alu_do = ((0U == (IData)(vlTOPp->alu_ctrl))
                       ? (vlTOPp->A & vlTOPp->B) : 
                      ((1U == (IData)(vlTOPp->alu_ctrl))
                        ? (vlTOPp->A | vlTOPp->B) : 
                       ((2U == (IData)(vlTOPp->alu_ctrl))
                         ? (vlTOPp->A + vlTOPp->B) : 
                        ((6U == (IData)(vlTOPp->alu_ctrl))
                          ? (vlTOPp->A - vlTOPp->B)
                          : ((7U == (IData)(vlTOPp->alu_ctrl))
                              ? (VL_LTS_III(1,32,32, vlTOPp->A, vlTOPp->B)
                                  ? 1U : 0U) : ((0xcU 
                                                 == (IData)(vlTOPp->alu_ctrl))
                                                 ? 
                                                (~ 
                                                 (vlTOPp->A 
                                                  | vlTOPp->B))
                                                 : 0U))))));
    vlTOPp->zero = (0U == vlTOPp->alu_do);
    vlTOPp->ovf = (1U & ((2U == (IData)(vlTOPp->alu_ctrl))
                          ? ((((~ (vlTOPp->A >> 0x1fU)) 
                               & (~ (vlTOPp->B >> 0x1fU))) 
                              & (vlTOPp->alu_do >> 0x1fU)) 
                             | (((vlTOPp->A & vlTOPp->B) 
